...
waste_data_long <- read_rds(here("wk-05/data/msw-generation-and-composition-by-income-long.rds"))
...
waste_data_long_mean <- read_rds(here("wk-05/data/msw-generation-and-composition-by-income-long-mean.rds"))
...
6.  Go to your wk-05-USERNAME GitHub repo (where USERNAME is your GitHub username) and refresh the page. You should see your commit message next to the updated files.

## Open an issue on GitHub

Once you have ensured that the Quarto document renders without errors and you have pushed all your changes to GitHub, it is to complete the assignment by opening an issue on your wk-05-USERNAME GitHub repo (where USERNAME is your GitHub username).

1.  Navigate to your wk-05-USERNAME GitHub repo (where USERNAME is your GitHub username).
